                                 ...
                                 char **string_in, const char *replacement)
{
  ...
  char *answer
      = (char *)calloc (strlen (string) - (endPosition - startPosition + 1)
                            + replacement_len + 1,
                        1);
  ...
  while (divisionSignLocation >= 0)
    {
      ...
      long n
          = find_operational_sign (expression + divisionSignLocation + 1, '/');
      if (n != -1)
  ...
  while (signLocation >= 0)
    {
      ...
      if (outputType == 0)
        simplifiedExponentiation
            = power (leftArgument, rightArgument, accuracy);
      if (outputType == 1)
        {
          ...
          struct fraction answer
              = power_fraction (fraction1, fraction2, accuracy);
      ...
      while (sign1 >= 0 && sign2 >= 0)
        {
          ...
          expression[sign2] = '/';
          char *denominator
              = (char *)calloc (strlen (div1) + strlen (div2) + 3, 1);
          ...
          strncpy (simplifiedChainDivision + strlen (numerator) + 1,
          ...
          if (outputType == 1)
            {
              ...
              operationResult = (char *)calloc (
                  ...
                  1);
              strncpy (operationResult, answer.numerator,
                       strlen (answer.numerator));
