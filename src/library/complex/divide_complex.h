...
struct complex divide_complex(struct complex numerator,
                              struct complex denominator, size_t accuracy) {
  ...
  char *buf1 =
      (char *)calloc(strlen(answer.real) + strlen(divisor) + accuracy + 3, 1);
