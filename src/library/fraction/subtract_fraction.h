#ifndef _subtract_fraction_h_
#define _subtract_fraction_h_
...
struct fraction subtract_fraction(struct fraction frac1,
  ...
  char *mul_1 = (char *)calloc(strlen(frac1.numerator) + frac2_den_len + 3, 1);
  char *mul_2 = (char *)calloc(strlen(frac2.numerator) + frac1_den_len + 3, 1);
  ...
  subtract(mul_1, mul_2, answer.numerator);
