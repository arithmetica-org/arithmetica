#ifndef _repeating_decimal_to_fraction_h_
#define _repeating_decimal_to_fraction_h_

#include <basic_math_operations.h>
#include <stdlib.h>
#include <string.h>

void repeating_decimal_to_fraction(const char *non_repeating_part_in,
                                   const char *repeating_part,
                                   char *numerator_out, char *denominator_out) {
  char *non_repeating_part = (char *)malloc(strlen(non_repeating_part_in) + 1);
